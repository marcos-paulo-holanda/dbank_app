...
document.querySelector("form").addEventListener("submit", async function(event){
  ...
  if (document.getElementById("input-amount").value.length != 0){await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.topUp(inputAmount);}
  if (document.getElementById("withdrawal-amount").value.length != 0){await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.withdraw(outputAmount);}
